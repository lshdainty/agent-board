...
// Seated rest (lowered by ~0.08 to simulate sitting)
const SEAT_OFFSET_Y = -0.12
const SEATED = {
  ...
  legL:      { pos: [-0.07, 0.08 + SEAT_OFFSET_Y, 0.06],rot: [-0.6, 0, 0] },
  legR:      { pos: [0.07, 0.08 + SEAT_OFFSET_Y, 0.06], rot: [-0.6, 0, 0] },
  shoeL:     { pos: [-0.07, 0.0 + SEAT_OFFSET_Y, 0.12], rot: [-0.3, 0, 0] },
  shoeR:     { pos: [0.07, 0.0 + SEAT_OFFSET_Y, 0.12],  rot: [-0.3, 0, 0] },
